<?php
 ...
 if($_POST['submitted'])
 {
	...
	//format user input put the stuff in super gobal and put in a variable
	$user = trim($_POST['user']);
	$pass = trim($_POST['pass']);
	
	if(empty($user) || empty($pass))
	{
			echo 'please fill in the sername and password fields';
	}
	else
	{
		...
		//if check is true check row name and username
		...
		{
			 echo 'Sorry, login infor incorrect';
	}
 }
 }
